...
class Estoque:
    ...
    def cadastrar_produtos(self):
        ...
        entrada_quantidade= input('Informe a quantidade de produtos:\n-->')

        print('-=' * 25)

        self.lista_produtos.append(Produtos(entrada_cod, entrada_nome, entrada_fabricante, entrada_quantidade))
